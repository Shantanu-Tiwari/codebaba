    ...
    return (
        <div className="space-y-6">
            <div className="space-y-2">
                ...
                <p className="text-muted-foreground">View all AI-generated code reviews</p>
            </div>
                            ...
                            <div className="lg:hidden space-y-3">
                                <div className="flex items-start justify-between">
                                    <div className="space-y-1">
                                        <CardTitle className="text-lg">#{review.prNumber} {review.prTitle}</CardTitle>
                                        <p className="text-sm text-muted-foreground">{review.repository.fullName}</p>
                                    </div>
                                    <a
                                        href={review.prUrl}
                                        target="_blank"
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        <Badge className={`text-xs text-white ${getStatusColor(review.status)}`}>
                                            {review.status}
                                        </Badge>
                            ...
                            <div className="hidden lg:grid grid-cols-12 gap-4 items-center">
                                <div className="col-span-4 space-y-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <CardTitle className="text-base">#{review.prNumber} {review.prTitle}</CardTitle>
                                    </div>
                                </div>
                                ...
                                <div className="col-span-2">
                                    <Badge className={`text-white ${getStatusColor(review.status)}`}>
                                        {review.status}
                                    </Badge>
                                </div>
